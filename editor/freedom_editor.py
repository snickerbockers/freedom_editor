...
def main():
    ...
    callbacks = {
        ...
        "on_project_build_everything" : freedomEditor.projectMenu.on_project_build_everything,
        "on_project_build_changes" : freedomEditor.projectMenu.on_project_build_changes,
